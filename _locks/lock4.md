...
<p>Le mot de passe est le nom d'un livre que vous trouverez à l'aide de <a href="/2024/09/02/farsector.html">ce post.</a></p>
{% endcapture %}
{% include lock.html title="Book 4" password="genesedelacite" lockNumber=4 clue=clue_content %}
