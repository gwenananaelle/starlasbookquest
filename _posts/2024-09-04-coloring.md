...
<div class="wrapper-grid col-500">
        <div>
          <img src="/assets/images/coloring/logo.png" alt="l'avatar de Rebel Queen Starla en couleur">
          <figcaption></figcaption>
        </div>
        <div>
          <img src="/assets/images/coloring/coloringcode.png" alt="l'avatar de Rebel Queen Starla à colorier">
          <figcaption></figcaption>
        </div>    
</div>